      ...
      <div className="grid md:grid-cols-2 gap-10 bg-white shadow-lg rounded-2xl p-8">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex gap-4 mt-8">
            <button className="bg-[#f58a7b] text-white px-6 py-3 rounded-lg hover:bg-[#ee7563] transition">
              Add to Cart
            </button>

            <button className="border border-[#f58a7b] text-[#f58a7b] px-6 py-3 rounded-lg hover:bg-[#f58a7b] hover:text-white transition">
              Buy Now
            </button>
          </div>
        </div>
